...
const InfoPage = () => {
    return (
      <div className="w-full h-full flex flex-col md:flex-row gap-6 p-6 bg-linear-to-br from-[#72C9A1] to-primary text-white overflow-auto">
        <InfoGuide />
        <motion.div
        ...
        >
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4 bg-linear-to-r from-[#72C9A1] to-primary bg-clip-text text-transparent">
              Welcome to Idein
            </h1>
          ...
          <div className="text-center mt-4 mb-8">
            <p className="text-lg mb-6 text-gray-700 max-w-2xl">
              Sign in to access your personalized notes and start recording
              right away.
            </p>
            <motion.button
